...
Lua 5.2 support, and 64-bit Ruby 2.2.0 support. Compiled with HUGE feature set
...
x64-msvcrt-ruby220.dll must be in your PATH to enable Ruby support. [Ruby
installer] (http://rubyinstaller.org/) provides this dll.
